...
<cfcomponent displayname="AssessmentALCOutcomeCategoriesGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="AssessmentALCOutcomeCategoriesGateway">
	...
	<cffunction name="getByAttributesQuery" access="public" output="false" returntype="query">
		...
		<cfif structKeyExists(arguments,"OtherDescription") and len(arguments.OtherDescription)>
			AND	OtherDescription = <cfqueryparam value="#arguments.OtherDescription#" CFSQLType="cf_sql_varchar" />
		</cfif>
	...
	<cffunction name="saveALCCategories" access="public" output="false" returntype="boolean">
		...
		<cfset var saveALCCategories = "" />		
		
		<cfquery name="saveALCCategories" datasource="#variables.dsn#">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","AssessmentALCOutcomeCategories").init(argumentCollection=queryRowToStruct(qList,i)) />
