...
<cfcomponent displayname="ProgramImprovementCodesGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="ProgramImprovementCodesGateway">
	...
	<cffunction name="getByAttributesQuery" access="public" output="false" returntype="query">
		...
		<cfif structKeyExists(arguments,"item_number") and len(arguments.item_number)>
			AND	item_number = <cfqueryparam value="#arguments.item_number#" CFSQLType="cf_sql_varchar" />
		</cfif>
		<cfif structKeyExists(arguments,"label") and len(arguments.label)>
			AND	label = <cfqueryparam value="#arguments.label#" CFSQLType="cf_sql_varchar" />
		</cfif>
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","ProgramImprovementCodes").init(argumentCollection=queryRowToStruct(qList,i)) />
