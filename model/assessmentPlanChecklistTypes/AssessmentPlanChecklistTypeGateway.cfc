...
<cfcomponent displayname="AssessmentPlanChecklistTypeGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="AssessmentPlanChecklistTypeGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","AssessmentPlanChecklistType").init(argumentCollection=queryRowToStruct(qList,i)) />
