<div id="pjax">
	...
	<ul class="clearfix">
		...
		<li><a href="#"><img src="images/icons/small/grey/frames.png"/><span>Layout</span></a>
			<ul class="open_multiple">
				...
				<li><a class="hide_mobile" href="#"><span>Layout Width</span></a>
					<ul class="drawer ">
						<li><a class="hide_mobile" href="styles/themes/layout_switcher.php?style=layout_fixed.css"><span>Fixed</span></a></li>
						<li><a class="hide_mobile" href="styles/themes/layout_switcher.php?style=switcher.css"><span>Fluid</span></a></li>
					</ul>
				</li>
				<li><a class="hide_mobile" href="#"><span>Layout Position</span></a>
					<ul class="drawer">
						<li><a class="hide_mobile" href="styles/themes/nav_switcher.php?style=switcher.css"><span>Side</span></a></li>
						<li><a class="hide_mobile" href="styles/themes/nav_switcher.php?style=nav_top.css"><span>Top</span></a></li>
						<li><a class="hide_mobile" href="styles/themes/nav_switcher.php?style=nav_slideout.css"><span>Slide</span></a></li>
						<li><a class="hide_mobile" href="styles/themes/nav_switcher.php?style=nav_stacks.css"><span>Stacks</span></a></li>
					</ul>
				</li>
		...
		<li><a href="#"><img src="images/icons/small/grey/coverflow.png"/><span>Widgets</span><div class="alert badge alert_blue">2</div></a>
			<ul>
		...
		<li><a href="#"><img src="images/icons/small/grey/create_write.png"/><span>Forms</span><div class="alert badge alert_orange">2</div></a>
			<ul>
		...
		<li><a href="gallery.php" class="pjax"><img src="images/icons/small/grey/images.png"/><span>Gallery</span></a></li>
		...
		<!--
		<li><a href="#"><img src="images/icons/small/grey/file_cabinet.png"/><span>Org</span><div class="alert badge alert_red">1</div></a>
			<ul>
				<li><a href="files.php" class="pjax"><img src="images/icons/small/grey/folder.png"/><span>Files</span></a></li>
				<li><a href="contacts.php" class="pjax"><img src="images/icons/small/grey/users.png"/><span>Contacts</span><div class="alert badge">&#9733</div></a></li>
			</ul>
		</li>
		-->
		<li><a href="contacts.php" class="pjax"><img src="images/icons/small/grey/users.png"/><span>Contacts</span></a></li>
		<li><a href="calendar.php" class="pjax"><img src="images/icons/small/grey/month_calendar.png"/><span>Cal</span></a></li>
		<li><a href="charts.php" class="pjax"><img src="images/icons/small/grey/graph.png"/><span>Charts</span></a>
			<ul class="dropdown_right">
				<li><a href="charts.php" class="pjax"><span>Large Charts</span></a></li>
				<li><a href="graphs.php" class="pjax"><span>Info Graphs</span></a><div class="alert badge alert_green">1</div></li>
			</ul></li>
		<li class="icon_only"><a href="#"><img src="images/icons/small/grey/locked_2.png"/><span class="display_none">Login</span></a>
			<ul class="dropdown_right">
				...
				<li><a href="#" class="dialog_button" data-dialog="dialog_logout"><span>Slide Login</span></a></li>
			</ul>
		</li>
	</ul>
						...
						<div class="block">
							...
							<fieldset class="label_side top">
								...
								<div>
									...
									<p class="comment"><a href="buttons.php">Click here</a> to see the full 500+ icon set including all the jQuery UI action icons.</p>
...
<option>Black</option>											</select>
	...
	<div id="dialog_welcome" class="dialog_content no_dialog_titlebar wide" title="Welcome to Adminica">
		...
		<div class="block lines">
			...
			<div class="columns clearfix no_lines">
				<form action="http://tricycle.us2.list-manage1.com/subscribe/post?u=5edde78118439e88c2f902a8e&amp;id=8b1499c4c6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
				<div class="col_33">
				...
				<div class="col_33">
					...
					<fieldset class="label_top">
						...
						<div class="required_tag" title="This field is required"></div>
						</div>
					</fieldset>
				</div>
				<div class="col_33 no_border_right">
					<fieldset class="label_top empty_label">
						<div class="clearfix">
							<button class="full_width" id="mailchimp_subscribe" onclick="$('#mc-embedded-subscribe-form').submit();"><span>Subscribe for Updates</span></button>
						</div>
					</fieldset>
				</div>
				</form>
